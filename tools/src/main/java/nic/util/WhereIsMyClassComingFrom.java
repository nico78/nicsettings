...
public class WhereIsMyClassComingFrom {
    ...
    public static void main(String[] args) {
        final String prefix = "com.google.common.base.Objects";
        System.out.println("Searching for " + prefix);
        final List<Class<?>> classes = searchClassPath(prefix);
    ...
    public static List searchClassPath(String prefix, String extension) {
        WhereIsMyClassComingFrom factory = new WhereIsMyClassComingFrom();
...
//        msg( "Looking in directory [" + dir.getName() + "].");
            ...
            if (entryName.toLowerCase().endsWith(this.extension)) {
                try {
                    if (this.extension.equalsIgnoreCase(".class")) {
                        ...
                        msg(
                                "Found class: [" + entryName + "]. " + " in archive " + archive.getName());
